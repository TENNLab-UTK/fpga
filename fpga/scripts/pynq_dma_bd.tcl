...
################################################################
# This is a generated script based on design: pynq_dma
#
...
# source pynq_dma_bd.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# axis_processor_tlast_top
...
proc create_root_design { parentCell inp_pkt_width_bits out_pkt_width_bits } {
  ...
  set_property -dict [list \
    ...
    CONFIG.PCW_FPGA0_PERIPHERAL_FREQMHZ {0.2} \
...
\
  ...
  if { [info exists inp_pkt_width_bits] == 0 } {
    set inp_pkt_width_bits 16
  }

  if { [info exists out_pkt_width_bits] == 0 } {
  ...
  if { [catch {set axis_processor_tlast_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     ...
     return 1
   } elseif { $axis_processor_tlast_0 eq "" } {
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins axis_processor_tlast_0/s]
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_dma_0_M_AXIS_MM2S] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins system_ila_6/SLOT_0_AXIS]
  ...
  connect_bd_intf_net -intf_net axis_processor_top_0_m [get_bd_intf_pins axis_processor_tlast_0/m] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
connect_bd_intf_net -intf_net [get_bd_intf_nets axis_processor_top_0_m] [get_bd_intf_pins axis_processor_tlast_0/m] [get_bd_intf_pins system_ila_7/SLOT_0_AXIS]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins ps7_0_axi_periph/M01_AXI] [get_bd_intf_pins debug_bridge_0/S_AXI]

  # Create port connections
  connect_bd_net -net axi_dma_0_mm2s_introut [get_bd_pins axi_dma_0/mm2s_introut] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net axi_dma_0_s2mm_introut [get_bd_pins axi_dma_0/s2mm_introut] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_dma_0/m_axi_sg_aclk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins debug_bridge_0/s_axi_aclk] [get_bd_pins system_ila_6/clk] [get_bd_pins system_ila_7/clk] [get_bd_pins axis_processor_tlast_0/clk] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins axi_mem_intercon/S02_ACLK]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins debug_bridge_0/s_axi_aresetn] [get_bd_pins system_ila_6/resetn] [get_bd_pins system_ila_7/resetn] [get_bd_pins axis_processor_tlast_0/arstn] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins axi_mem_intercon/S02_ARESETN]
  ...
  assign_bd_address -offset 0x40000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs debug_bridge_0/S_AXI/Reg0] -force
...
create_root_design "" $inp_pkt_width_bits $out_pkt_width_bits
